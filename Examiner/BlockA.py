...
class BlockA():
    ...
    def check(self): 
        ...
        if self.entry_answer_1.get().lower() == 'фамилия1':
        ...
        if self.entry_answer_2.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_3.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_4.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_5.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_6.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_7.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        if self.entry_answer_8.get().lower() == 'фамилия1':
            right_counter += 1
        ...
        check_set = {'фамилия1', 'фамилия2', 'фамилия3'}
