...
class BlockB():
    ...
    def check(self): 
        ...
        check_sets = {1: {'фамилия1', 'фамилия2', 'фамилия3'},
                      2: {'фамилия1', 'фамилия2', 'фамилия3'},
                      3: {'фамилия1', 'фамилия2', 'фамилия3'},
                      4: {'фамилия1', 'фамилия2', 'фамилия3'},
                      5: {'фамилия1', 'фамилия2', 'фамилия3'},
                      6: {'фамилия1', 'фамилия2', 'фамилия3'}}
